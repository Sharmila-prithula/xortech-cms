                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a href="{{route('admin.about')}}" class="btn btn-success">All Abouts</a>
                            </div>
                        </div>
                    </div>
                    <div class="panel-body">
                        ...
                        @endif
                        <form class="form-horizontal" enctype="multipart/form-data" wire:submit.prevent="updateAbout">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="file" class="input-file" name="image" wire:model="newimage">
                                    @error('image') <span class="error">{{ $message }}</span>@enderror
                                    @if($newimage)
                                    <img src="{{$newimage->temporaryUrl()}}" width="120" />
                                    @else
                                        <img src="{{asset('images/about/'.$image) }}" width="120">
                                    @endif
                                </div>
                            </div>
                            <div class="form-group">

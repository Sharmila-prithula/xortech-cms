                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="/admin/blogs/{{ $blog->id }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button style="border: none;" onclick="confirm('Are your sure, your want to delete this blog?') || event.stopImmediatePropagation()"><i class="fa fa-times fa-2x"></i></button>
                                    </form>
                                </td>
                            </tr>
                            @endforeach

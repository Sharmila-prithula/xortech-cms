            ...
            <div class="row pt-5 ">
                <div class="col-lg-4 pt-5 ">
                    <div class="blog-image  mt-3 ">
                        <img src="{{asset('images/blogs/'.$blog->images)}}" alt="blog imgae " class="img-fluid w-100 ">
                    </div>
                </div>
                <div class="col-lg-8 p-5">
                    <div class="blog-text ">
                        ...
                        <p>{!! substr_replace($blog->content, "...", 100) !!}
                            <a class="text-indigo-600 hover-text-indigo-900" target="_self" href="{{URL::to('/'.$blog->slug)}}">
